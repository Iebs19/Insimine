  ...
  return (
    <>
      <div className="z-10 flex flex-col justify-center">
        ...
        <GradualSpacing
          className="font-nas pb-2 text-7xl text-left bg-gradient-to-b from-green to-lightBlue bg-clip-text text-transparent dark:from-green dark:to-lightBlue"
          text="Mining Insights for"
        />
        <GradualSpacing
          className="font-nas text-7xl text-left"
