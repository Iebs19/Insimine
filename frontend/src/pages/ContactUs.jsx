...
function ContactUs() {
    return (
        <div className="flex flex-col pt-4 px-4 md:px-8">
            <div className="font-nas font-bold justify-center text-4xl sm:text-5xl lg:text-7xl text-center lg:text-left">
                Contact Our Team
            </div>
            <div className="flex flex-col justify-center mr-auto pt-6 text-center lg:text-left">
                <div className="font-nas mx-4 text-lg sm:text-2xl">
                    Connect to our team to ask a question or learn more about how we can support your business.
                </div>
            </div>

            {/* Contact Form */}
            <div className="p-4 text-black dark:text-white mt-4 w-full lg:w-2/3 mx-auto">
                <NeonGradientCard className="w-full lg:w-full">
                    <ContactUsForm />
                </NeonGradientCard>
            </div>
            ...
            {/* Offices */}
            <div className="flex flex-col justify-center">
                <h1 className="font-nas text-3xl sm:text-5xl pt-6 text-center lg:text-left">Our Offices</h1>
                <div className="px-4 lg:px-20 w-full">
                    <Accordion type="multiple">
                        <AccordionItem value="item-1">
                            <AccordionTrigger className="font-nas text-xl sm:text-3xl">Asia Pacific</AccordionTrigger>
                            <AccordionContent className="text-left">
                                <h1 className="font-nas text-lg sm:text-2xl">India</h1>
                                <div className="m-7">
                                    <LocationOnIcon />
                                    <a>207-208 Welldone TechPark, Sohna Road Sector 48, Gurugram, Haryana 122018, India</a>
                                </div>
                        ...
                        <AccordionItem value="item-2">
                            <AccordionTrigger className="font-nas text-xl sm:text-3xl">USA</AccordionTrigger>
                            <AccordionContent className="text-left">
                                <h1 className="font-nas text-lg sm:text-2xl">Delaware</h1>
                                <div className="m-7">
                                    <LocationOnIcon />
                                    <a>8 The Green, Suite B, Dover, DE 19901</a>
                                </div>
                            ...
                            <AccordionContent className="text-left">
                                <h1 className="font-nas text-lg sm:text-2xl">California</h1>
                                <div className="m-7">
                                    <LocationOnIcon />
                                    <a>99 S Almaden Blvd, Suite 600, San Jose, CA</a>
                                </div>
                        ...
                        <AccordionItem value="item-3">
                            <AccordionTrigger className="font-nas text-xl sm:text-3xl">Europe</AccordionTrigger>
                            <AccordionContent className="text-left">
                                <h1 className="font-nas text-lg sm:text-2xl">United Kingdom</h1>
                                <div className="m-7">
                                    <LocationOnIcon />
                                    <a>13 Freeland Park, Poole, Dorset, United Kingdom, BH16 6FH</a>
                                </div>
                            ...
                            <AccordionContent className="text-left">
                                <h1 className="font-nas text-lg sm:text-2xl">Germany</h1>
                                <div className="m-7">
                                    <LocationOnIcon />
                                    <a>5th Floor, Hahnstrasse 70, Frankfurt am main, 60528</a>
                                </div>
