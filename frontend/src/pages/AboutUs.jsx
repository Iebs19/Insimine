...
const AboutUs = () => {
  ...
  return (
    <div className='flex flex-col justify-center pt-4 px-4 md:px-8 lg:px-12'>
      {/* Main Title */}
      <div className='font-nas font-bold text-4xl sm:text-5xl lg:text-7xl text-center lg:text-left'>
        About Us
      </div>

      {/* Introduction Text */}
      <div className='flex flex-col justify-center pt-6 md:pt-12 lg:pt-16'>
      ...
      {/* Values Section */}
      <div className='flex flex-col lg:flex-row gap-8 lg:gap-16 pt-8 lg:pt-12'>
        <motion.div {...floatAnimation} className="mx-auto lg:mx-0">
          <img width='200' height='200' src={valueimg} alt="Our Values" />
        </motion.div>
        <motion.div {...floatAnimation} className='lg:p-4'>
          <NeonGradientCard className='bg-background'>
            <h1 className='font-nas text-3xl sm:text-4xl'>Our Values</h1>
            <div className='text-left pt-2 text-sm sm:text-base lg:text-lg'>
              <li>Innovation: Continuously pushing the boundaries of what’s possible with data and technology.</li>
              <li>Integrity: Upholding the highest standards of ethics and transparency in all our dealings.</li>
              <li>Collaboration: Working closely with our clients to understand their unique challenges and deliver tailored solutions.</li>
              <li>Excellence: Committed to delivering the highest quality services and solutions.</li>
      ...
      <div className='flex flex-col lg:flex-row justify-between gap-8 lg:gap-16 pt-8'>
        <motion.div {...floatAnimation} className="lg:w-1/2">
          <NeonGradientCard>
            <h1 className='font-nas text-3xl sm:text-4xl'>Our Mission</h1>
            <div className='text-center pt-2 text-sm sm:text-base lg:text-lg'>
              To enable pharmaceutical and healthcare organizations to harness the power of their data for improved decision-making, better patient outcomes, and enhanced operational efficiency.
            </div>
          </NeonGradientCard>
        </motion.div>
        <motion.div {...floatAnimation} className="lg:w-1/2">
          <NeonGradientCard>
            <h1 className='font-nas text-3xl sm:text-4xl'>Our Vision</h1>
            <div className='text-center pt-2 text-sm sm:text-base lg:text-lg'>
              To be the global leader in data analytics and AI solutions for the pharmaceutical and healthcare industries, transforming businesses through innovative technologies.
            </div>
          </NeonGradientCard>
      ...
      {/* Approach Section */}
      <div className='flex flex-col lg:flex-row justify-between gap-8 lg:gap-16 pt-8'>
        <motion.div {...floatAnimation} className='lg:w-1/2 lg:p-4'>
          <NeonGradientCard>
            <h1 className='font-nas text-3xl sm:text-4xl'>Our Approach</h1>
            <div className='text-left pt-2 text-sm sm:text-base lg:text-lg'>
              <li>Strategize and Plan: Develop comprehensive strategies and project plans to ensure successful execution.</li>
              <li>Discovery and Design: Uncover insights and design solutions that align with your goals and vision.</li>
              <li>Build and Deploy: Implement secure, reliable AI solutions and scale them to production.</li>
        ...
        <motion.div {...floatAnimation} className="mx-auto lg:mx-0">
          <img width='300' height='300' src={methodimg} alt="Our Approach" />
        </motion.div>
      </div>

      {/* Why InsiMine Section */}
      <div className='flex justify-center pt-8 lg:pt-12'>
        <motion.div {...floatAnimation} className="w-full lg:w-2/3">
          <NeonGradientCard>
            <h1 className='font-nas text-3xl sm:text-4xl'>Why InsiMine</h1>
            <div className='text-left pt-2 text-sm sm:text-base lg:text-lg'>
              <li>Industry Expertise: Extensive experience in the pharmaceutical and healthcare sectors.</li>
              <li>Advanced Technology: Leveraging the latest in data engineering, big data management, and AI technologies.</li>
              <li>Proven Track Record: Demonstrated success in driving growth, improving efficiency, and enhancing patient outcomes.</li>
