  ...
  return (
    <div className='flex flex-col justify-center pt-4'>
      ...
      <div className='flex flex-col pt-12 px-24'>
        <div className='flex flex-row justify-between pt-10 sticky top-5 bg-background z-10' id='service1'>
          <div className='flex flex-col w-1/2 justify-between' id='row1'>
            <div className='flex sticky font-nas text-4xl text-left'>
              1. Data Engineering
            </div>
            {/* <img src={DataEng} alt="Data Engineering" height='300' width='300' /> */}
          </div>
          <div className='flex flex-col font-nas text-2xl overflow-y-auto w-1/2' id='row2'>
        ...
        <div className='flex flex-row justify-between pt-10 sticky top-5 bg-background z-10' id='service2'>
          <div className='flex font-nas text-4xl text-left w-1/2'>
            2. Data Lakes & Big Data Management
          </div>
          <div className='flex flex-col font-nas text-2xl w-1/2'>
            <h1 className='text-sm'>
              InsiMine offers a comprehensive data engineering framework designed specifically for the pharmaceutical and healthcare industries. Our services help you develop a robust data strategy, ensure data governance, and optimize data management processes.
            </h1>
            <Accordion type="multiple">
        ...
        <div className='flex flex-row justify-between pt-10 sticky top-5 bg-background z-10' id='service3'>
          <div className='flex font-nas text-4xl text-left w-1/2'>
